...
public enum ReaxysDataTypes {
	...
	BIO ("Bioaccumulation, Biomagnification and Biomonitoring", "BIO", "S", "RX", new String[] {"IDE"}),
	DAT ("Bioactivity", "DAT", "DPI", "RX", new String[] {"IDE" , "DATIDS", "CONCOM", "METABS"}),
	DX ("Bioactivity Data Point Availability", "DX", "DPI", "RX", new String[] {"DAT"}),
	DATIDS ("Bioactivity Target IDs", "DATIDS", "DPI", "RX", new String[] {"DATIDS"}),
